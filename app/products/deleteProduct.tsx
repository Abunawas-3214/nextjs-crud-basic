...
export default function DeleteProduct(product: Product) {
    ...
    async function hadleDelete(productId: number) {
        setIsMutating(true)
            ...
            <div className="modal">
                <div className="modal-box">
                    ...
                    <div className="modal-action">
                        ...
                        {!isMutating ? (
                            <button type="button" onClick={() => hadleDelete(product.id)} className="btn btn-primary">Delete</button>
                        ) : (
                            <button type="button" className="btn laoding">Deleting...</button>
                        )}
                    </div>
